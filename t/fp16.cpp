...
TEST_CASE("fp16 default constructors and conversion","[fp16]") {
...
TEST_CASE("fp16 comparison operators","[fp16]") {
...
TEST_CASE("fp16 swap function","[fp16]") {
